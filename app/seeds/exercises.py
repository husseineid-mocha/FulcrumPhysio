...
def seed_exercises():
    ...
    lowerTrunkRotations = Exercise(
        name='Lower Trunk Rotations', image='https://fulcrumphysio.s3.amazonaws.com/8lowerTrunkRotations.jpeg', description='Lying on your back with your knees bent, gently rotate your spine as you move your knees to the side and then reverse directions and move your knees to the other side. Repeat as you move through a comfortable range of motion.', categoryId=8)
    singleKneeToChest = Exercise(
        name='Single Knee To Chest', image='https://fulcrumphysio.s3.amazonaws.com/8singleKneeToChest.jpeg', description='While Lying on your back, raise your leg up and hold your thigh under your knee while gently pulling it towards your chest for a gentle stretch. Lower your leg down and repeat.', categoryId=8)
    pelvicTilt = Exercise(
        name='Pelvic Tilt', image='https://fulcrumphysio.s3.amazonaws.com/8pelvicTilt.jpeg', description='Lie on your back with your knees bent. Next, arch your low back and then flatten it repeatedly. Your pelvis should tilt forward and back during the movement. Move through a comfortable range of motion.', categoryId=8)
    catCamel = Exercise(
        name='Cat / Camel', image='https://fulcrumphysio.s3.amazonaws.com/8catCamel.jpeg', description='While on your hands and knees in a crawl position, raise up your back and arch it towards the ceiling like an angry cat. Next return to a lowered position and arch your back the opposite direction.', categoryId=8)
    birdDog = Exercise(
        name='Bird Dog', image='https://fulcrumphysio.s3.amazonaws.com/8birdDog.jpeg', description='While in a crawling position, brace at your abdominals and then slowly lift a leg and opposite arm upwards. Your hip will move into hip extension on the way up. Lower leg and arm down and then repeat with opposite side. Maintain a level and stable pelvis and spine the entire time.', categoryId=8)
    tvaBracing = Exercise(
